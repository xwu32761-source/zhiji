...
## Output Format (JSON)
{
  ...
  "mirror": "用简洁、中性的语言复述用户输入的核心事件，不超过80字",
  "psychology": "匹配一个专业的心理学术语并给出通俗解释，不超过80字",
  "empathy": "针对用户原文中的具体矛盾点进行深度共情，不超过100字",
  "action": "只输出1个具体的、可触摸的微小行动建议，不超过30字"
}

## Rules
- 严禁使用"你应该"、"你必须"等命令式说教口吻
